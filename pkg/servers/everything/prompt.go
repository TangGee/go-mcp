...
func (s *Server) GetPrompt(
	...
	case "complex-prompt":
		...
		if !ok {
			return mcp.PromptResult{}, fmt.Errorf("temperature argument not found")
		}
		temperature, err := strconv.ParseFloat(temp, 64)
		if err != nil {
			return mcp.PromptResult{}, fmt.Errorf("temperature argument is not a float64")
		}
